...
describe('Debug', () => {
  describe('statements', () => {
    it('should be printed according to the configured level', function () {
      ...
      assert(console.info.calledWith('debug(1)'))
      assert(console.info.calledWith('debug(2)'))
      assert(console.info.calledWith('debug(3)'))
      assert(console.info.calledWith('debug(4)'))
      assert(console.info.calledWith('debug(5)'))
      ...
      assert(!console.info.calledWith('debug2(1)'))
      assert(console.info.calledWith('debug2(2)'))
      assert(console.info.calledWith('debug2(3)'))
      assert(console.info.calledWith('debug2(4)'))
      assert(console.info.calledWith('debug2(5)'))
      ...
      assert(!console.info.calledWith('debug3(1)'))
      assert(!console.info.calledWith('debug3(2)'))
      assert(console.info.calledWith('debug2(3)'))
      assert(console.info.calledWith('debug2(4)'))
      assert(console.info.calledWith('debug2(5)'))
      ...
      assert(!console.info.calledWith('debug4(1)'))
      assert(!console.info.calledWith('debug4(2)'))
      assert(!console.info.calledWith('debug4(3)'))
      assert(console.info.calledWith('debug4(4)'))
      assert(console.info.calledWith('debug4(5)'))
      ...
      assert(!console.info.calledWith('debug5(1)'))
      assert(!console.info.calledWith('debug5(2)'))
      assert(!console.info.calledWith('debug5(3)'))
      assert(!console.info.calledWith('debug5(4)'))
      assert(console.info.calledWith('debug2(5)'))
    })
    ...
    it('should allow for multiple arguments', function () {
      ...
      assert(console.info.calledWith('debug', '1', '2', '3'))
    })
  })
  ...
  describe('timings', () => {
    it('should be recorded', function () {
      ...
      assert(console.time.calledWith('debug()'))

      debug(state1, 'debug():end')
      assert(console.timeEnd.calledWith('debug()'))
    })
  })
})
